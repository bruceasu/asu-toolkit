...
@REM ==== 固定 JDK 路径设置（项目专用） ====
set "JAVA_HOME=C:\green\jdk-21.0.2"
set "PATH=%JAVA_HOME%\bin;%PATH%"
echo Using fixed JDK: %JAVA_HOME%
:: set "MAVEN_CONFIG=-s "%~dp0\.mvn\settings.xml""

call :getScriptLocation location
set "MAVEN_CONFIG=-s "%location%\.mvn\settings.xml""
goto next
:: exit /b %errorlevel%
