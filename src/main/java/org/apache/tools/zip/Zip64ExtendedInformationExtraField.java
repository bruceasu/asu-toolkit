 ...
 * <p>
 * From
 * {@link "http://www.pkware.com/documents/casestudies/APPNOTE.TXT PKWARE's APPNOTE.TXT"}
 * 
 * <pre>
 ...
 * 
 * <p>
 * Currently Ant doesn't support encrypting the central directory so the note
 * about masking doesn't apply.
 * </p>
 * 
 * <p>
...
public class Zip64ExtendedInformationExtraField implements CentralDirectoryParsingZipExtraField {
	 ...
	 */
	public Zip64ExtendedInformationExtraField(ZipEightByteInteger size,
			ZipEightByteInteger compressedSize, ZipEightByteInteger relativeHeaderOffset,
			ZipLong diskStart) {
		this.size = size;
		...
		if (rawCentralDirectoryData != null) {
			...
			if (rawCentralDirectoryData.length < expectedLength)
				throw new ZipException("central directory zip64 extended"
						...
						+ " data.  Expected length " + expectedLength + " but is "
