 ...
 * {@link <a href="http://www.pkware.com/documents/casestudies/APPNOTE.TXT"> APPNOTE.txt</a>}
 * :
 * </p>
 * <ul>
 ...
 * class. Older versions would have thrown an exception if any attempt was made
 * to read or write extra data not conforming to the recommendation.
 * </p>
 * 
 */
public class ZipEntry extends java.util.zip.ZipEntry implements Cloneable {
	 ...
	 * 
	 * <p>
	 * The name will be adjusted to end with a forward slash "/" if the file is
	 * a directory. If the file is not a directory a potential trailing forward
	 * slash will be stripped from the entry name.
	 * </p>
	 */
	...
	public boolean equals(Object obj) {
		...
		return getTime() == other.getTime() && myComment.equals(otherComment)
				...
				&& getMethod() == other.getMethod() && getSize() == other.getSize()
	 ...
	 * 
	 * @return PLATFORM_FAT unless {@link #setUnixMode setUnixMode} has been
	 *         called, in which case PLATFORM_UNIX will be returned.
	 * 
	 * @since Ant 1.5.2
	 */
	 ...
	 * unparseable data as an {@link UnparseableExtraFieldData} instance.
	 * 
	 * @param extra
	...
	public void setExtra(byte[] extra) throws RuntimeException {
		try {
			...
			throw new RuntimeException("Error parsing extra fields for entry: " + getName() + " - "
					+ e.getMessage(), e);
		}
	}
