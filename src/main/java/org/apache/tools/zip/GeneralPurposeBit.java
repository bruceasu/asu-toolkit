...
public final class GeneralPurposeBit {
	 ...
	 */
	public byte[] encode() {
		return ZipShort.getBytes((dataDescriptorFlag ? DATA_DESCRIPTOR_FLAG : 0)
	...
	@Override
	public int hashCode() {
		return 3 * (7 * (13 * (17 * (encryptionFlag ? 1 : 0) + (strongEncryptionFlag ? 1 : 0)) + (languageEncodingFlag ? 1
				: 0)) + (dataDescriptorFlag ? 1 : 0));
	}
