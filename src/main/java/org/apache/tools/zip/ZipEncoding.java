 ...
 * with {@link String#getBytes(String)
 * String.getBytes}, which encodes unknown characters as ASCII quotation marks
 * ('?'). Quotation marks are per definition an invalid filename on some
