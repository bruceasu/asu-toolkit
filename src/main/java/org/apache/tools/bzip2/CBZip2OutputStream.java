...
public class CBZip2OutputStream extends OutputStream implements BZip2Constants {
	...
	static final class Data extends Object {
		 ...
		 * 
		 * <p>
		 * This is the index in fmap that points to the last byte of the
		 * original data.
		 * </p>
		 */
		int origPtr;
	...
	private static void hbAssignCodes(final int[] code, final byte[] length, final int minLen,
	...
	private static void hbMakeCodeLengths(final byte[] len, final int[] freq, final Data dat,
			final int alphaSize, final int maxLen) {
		/*
	...
	public CBZip2OutputStream(final OutputStream out, final int blockSize) throws IOException {
		...
		allowableBlockSize = (blockSize100k * BZip2Constants.baseBlockSize) - 20;
		init();
	}
	...
	private void sendMTFValues() throws IOException {
		...
		final int nGroups = (nMTF < 200) ? 2 : (nMTF < 600) ? 3 : (nMTF < 1200) ? 4
				: (nMTF < 2400) ? 5 : 6;
	...
	private void sendMTFValues4() throws IOException {
		...
		final boolean[] inUse16 = data.sentMTFValues4_inUse16;
	 ...
	 * 
	 * <p>
	 * "write to the buffer" means adding to data.buffer starting two steps
	 * "after" this.last - initially starting at index 1 (not 0) - and updating
	 * this.last to point to the last index written minus 1.
	 * </p>
	 */
