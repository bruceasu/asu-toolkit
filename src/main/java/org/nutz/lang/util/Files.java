...
public abstract class Files {
    ...
    public static List<String> readLines(File f, String charset) {
        ...
        BufferedReader br = null;
        try {
            br = me.asu.util.Streams.buffr(me.asu.util.Streams.fileInr(f, charset));
            while (br.ready()) {
                lines.add(br.readLine());
            }
        } catch (IOException e) {
            ...
            me.asu.util.Streams.safeClose(br);
        }
        return lines;
    }
    ...
    public static class LineIterator implements Iterator<String> {
        ...
        public LineIterator(File f) {
            br = me.asu.util.Streams.buffr(me.asu.util.Streams.fileInr(f));
        }
