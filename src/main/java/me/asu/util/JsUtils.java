...
public class JsUtils {
    ...
    public static Object eval(ScriptEngine engine, File file) throws IOException, ScriptException {
    ...
    public static Object eval(ScriptEngine engine, String js, Bindings n) throws ScriptException {
        if (n == null) {
            return engine.eval(js);
        } else {
    ...
    public Object eval(File file, Bindings n) throws IOException, ScriptException {
        Reader reader = Files.newBufferedReader(file.toPath());
        if (n == null) {
            return engine.eval(reader);
        } else {
    ...
    public Object eval(String js, Bindings n) throws ScriptException {
        if (n == null) {
            return engine.eval(js);
        } else {
            return engine.eval(js, n);
    ...
    public Object callMethod(String objName, String fn, Object... parameters)
            throws ScriptException, NoSuchMethodException {
        Invocable invoke = (Invocable) engine;
    ...
    public CompiledScript compile(File file) throws ScriptException, IOException {
        Compilable c = (Compilable) engine;
        Reader reader = Files.newBufferedReader(file.toPath());
