...
public class TableGenerator {
    ...
    public static Map<Integer, Integer> getMaximumWidthOfTable(List<String> headersList,
        ...
        Map<Integer, Integer> columnMaxWidthMapping = new HashMap<Integer, Integer>(4);
    ...
    private void fillCell(StringBuilder stringBuilder, String cell, int cellIndex,
        ...
        if (startWithSpace && endWithSpace) {
            // align center
            int cellPaddingSize = getOptimumCellPadding(cellIndex, getTextLength(cell),
                    columnMaxWidthMapping,
                    PADDING_SIZE);
            ...
            if (cell.matches("[0-9.Ee%]+")) {
                ...
                stringBuilder.append(cell);
                    ...
                    "\\d{2,4}.\\d{1,2}.\\d{1,2}( \\d{1,2}:\\d{1,2}:\\d{1,2}(.\\d{3})?)?")) {
    ...
    public static void main(String[] args) {
        List<String> headersList = java.util.Arrays.asList("col1", "column2", "列3");
        List<List<String>> rowsList = new ArrayList<List<String>>();
        rowsList.add(java.util.Arrays.asList("english", "简体中文", "繁体"));
        rowsList.add(java.util.Arrays.asList("english", " 简体中文 ", "繁体 "));
        rowsList.add(java.util.Arrays.asList(makeAlignRight("english"), makeAlignCenter("简体中文"),
                makeAlignLeft(" 12343554")));
        rowsList.add(java.util.Arrays.asList("2010-10-10 12:21:22", "简体中文", "繁体"));
