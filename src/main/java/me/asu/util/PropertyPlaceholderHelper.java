...
/**
 * source code from spring <p> Utility class for working with Strings that have placeholder values
 * in them. A placeholder takes the form {@code ${name}}. Using {@code PropertyPlaceholderHelper}
 * these placeholders can be substituted for user-supplied values. <p> Values for substitution can
 * be supplied using a {@link Properties} instance
 *
...
public class PropertyPlaceholderHelper {
    ...
    public PropertyPlaceholderHelper(String placeholderPrefix, String placeholderSuffix,
        ...
        if (simplePrefixForSuffix != null && this.placeholderPrefix
                .endsWith(simplePrefixForSuffix)) {
        ...
        while (startIndex != -1) {
            ...
            if (endIndex != -1) {
                ...
                if (propVal != null) {
                    ...
                    startIndex = result
                            .indexOf(this.placeholderPrefix, startIndex + propVal.length());
