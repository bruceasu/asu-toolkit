...
public class JavascriptUtils {
    ...
    public static final int LEVEL_DEBUGGABLE = COMPRESS_STRIP_SL_COMMENTS
            | COMPRESS_STRIP_ML_COMMENTS | COMPRESS_TRIM_LINES | COMPRESS_STRIP_BLANKLINES;
     ...
     */
    public static final int LEVEL_NORMAL = LEVEL_DEBUGGABLE | COMPRESS_SHRINK_VARS;
    ...
    public static String trimLines(String text) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "IOExecption unexpected.", ex);
    ...
    private static final String[] RESERVED_ARRAY = new String[]{
            ...
            "import", "in", "instanceof", "is", "namespace", "new", "null", "package", "private",
            "public", "return", "super", "switch", "this", "throw", "true", "try", "typeof", "use",
            "var", "void", "while",
            "with",
            // Reserved for future use at ECMAScript 4
            "abstract", "debugger", "enum", "goto", "implements", "interface", "native",
            "protected", "synchronized", "throws", "transient", "volatile",
