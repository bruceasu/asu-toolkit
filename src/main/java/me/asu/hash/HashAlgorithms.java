...
public final class HashAlgorithms {
  ...
  public static final HashAlgorithm JENKINS_HASH  = new JenkinsHash();
  public static final HashAlgorithm MURMUR_HASH = new MurmurHash();
  ...
  public static class JenkinsHash extends Hash {
   ...
   */
  public static class MurmurHash extends Hash {
