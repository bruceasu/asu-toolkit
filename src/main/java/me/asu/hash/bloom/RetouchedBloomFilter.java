 ...
 * @see <a href="http://www-rp.lip6.fr/site_npa/site_rp/_publications/740-rbf_cameraready.pdf">Retouched
 * Bloom Filters: Allowing Networked Applications to Trade Off Selected False Positives Against
 * False Negatives</a>
 */
public final class RetouchedBloomFilter extends BloomFilter
    ...
    /**
     * Chooses the bit position that minimizes the number of false negative generated while
     * maximizing. the number of false positive removed.
     *
     * @param h The different bit positions.
