...
public class InvokersTest {
    ...
    //         Getter getter = Invokers
    //                 .newInvoker(Getter.class, Date.class, "getTime", null, Long.TYPE);
    //         // 创建setter调用器，用于调用setTime方法
    //         Setter setter = Invokers
    //                 .newInvoker(Setter.class, Date.class, "setTime", new Class<?>[]{Long.TYPE},
    //                         null);
    //         Date date = new Date();
